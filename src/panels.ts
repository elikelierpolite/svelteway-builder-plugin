...
export default (editor: grapesjs.Editor, opts: RequiredPluginOptions) => {
  ...
  const prv = "preview";
  const iconStyle = 'style="max-width:22px"';
      ...
      buttons: [
        {
          ...
          active: true,
          label: `<svg ${iconStyle} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      buttons: [
        {
          ...
          command: swv,
          context: swv,
          label: `<svg ${iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="currentColor" stroke-linecap="round" stroke-linejoin="round">
      ...
      buttons: [
        {
          ...
          command: osm,
          active: true,
          label: `<svg ${iconStyle} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
